...
class Gameboy {
  ...
  Gameboy(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;
  ...
  late final _gb_initPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>('gb_init');
  late final _gb_init = _gb_initPtr.asFunction<void Function()>();

  void gb_step_frame() {
    return _gb_step_frame();
  }

  late final _gb_step_framePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>('gb_step_frame');
  late final _gb_step_frame = _gb_step_framePtr.asFunction<void Function()>();

  ffi.Pointer<ffi.Uint32> gb_get_framebuffer() {
    return _gb_get_framebuffer();
  }

  late final _gb_get_framebufferPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Uint32> Function()>>(
          'gb_get_framebuffer');
  late final _gb_get_framebuffer =
      _gb_get_framebufferPtr.asFunction<ffi.Pointer<ffi.Uint32> Function()>();
  ...
  late final _gb_load_romPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<ffi.Uint8>, ffi.Int)>>('gb_load_rom');
  late final _gb_load_rom =
      _gb_load_romPtr.asFunction<void Function(ffi.Pointer<ffi.Uint8>, int)>();

  void gb_reset() {
    return _gb_reset();
  }

  late final _gb_resetPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>('gb_reset');
  late final _gb_reset = _gb_resetPtr.asFunction<void Function()>();
  ...
  late final _mmu_initPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<MMU>)>>(
          'mmu_init');
  late final _mmu_init =
      _mmu_initPtr.asFunction<void Function(ffi.Pointer<MMU>)>();
  ...
  late final _mmu_read8Ptr = _lookup<
          ffi.NativeFunction<ffi.Uint8 Function(ffi.Pointer<MMU>, ffi.Uint16)>>(
      'mmu_read8');
  late final _mmu_read8 =
      _mmu_read8Ptr.asFunction<int Function(ffi.Pointer<MMU>, int)>();
  ...
  late final _mmu_write8Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<MMU>, ffi.Uint16, ffi.Uint8)>>('mmu_write8');
  late final _mmu_write8 =
      _mmu_write8Ptr.asFunction<void Function(ffi.Pointer<MMU>, int, int)>();
  ...
  late final _mmu_load_romPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<MMU>, ffi.Pointer<ffi.Uint8>,
              ffi.Size)>>('mmu_load_rom');
  late final _mmu_load_rom = _mmu_load_romPtr.asFunction<
      void Function(ffi.Pointer<MMU>, ffi.Pointer<ffi.Uint8>, int)>();
  ...
  late final _cpu_initPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<CPU>)>>(
          'cpu_init');
  late final _cpu_init =
      _cpu_initPtr.asFunction<void Function(ffi.Pointer<CPU>)>();
  ...
  late final _cpu_stepPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<CPU>)>>(
          'cpu_step');
  late final _cpu_step =
      _cpu_stepPtr.asFunction<int Function(ffi.Pointer<CPU>)>();
  ...
  late final _cpu_step_cbPtr = _lookup<
          ffi.NativeFunction<ffi.Int Function(ffi.Pointer<CPU>, ffi.Uint8)>>(
      'cpu_step_cb');
  late final _cpu_step_cb =
      _cpu_step_cbPtr.asFunction<int Function(ffi.Pointer<CPU>, int)>();

  void cpu_connect_mmu(
    ffi.Pointer<MMU> mmu,
  ) {
    return _cpu_connect_mmu(
      mmu,
    );
  }

  late final _cpu_connect_mmuPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<MMU>)>>(
          'cpu_connect_mmu');
  late final _cpu_connect_mmu =
      _cpu_connect_mmuPtr.asFunction<void Function(ffi.Pointer<MMU>)>();
  ...
  late final _ppu_initPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<PPU>)>>(
          'ppu_init');
  late final _ppu_init =
      _ppu_initPtr.asFunction<void Function(ffi.Pointer<PPU>)>();
  ...
  late final _ppu_stepPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<PPU>, ffi.Pointer<MMU>, ffi.Int)>>('ppu_step');
  late final _ppu_step = _ppu_stepPtr
      .asFunction<void Function(ffi.Pointer<PPU>, ffi.Pointer<MMU>, int)>();

  void ppu_render_frame(
    ffi.Pointer<PPU> ppu,
    ffi.Pointer<MMU> mmu,
  ) {
    return _ppu_render_frame(
      ppu,
      mmu,
    );
  }

  late final _ppu_render_framePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<PPU>, ffi.Pointer<MMU>)>>('ppu_render_frame');
  late final _ppu_render_frame = _ppu_render_framePtr
      .asFunction<void Function(ffi.Pointer<PPU>, ffi.Pointer<MMU>)>();
}
...
final class MMU extends ffi.Struct {
  @ffi.Array.multi([32768])
  external ffi.Array<ffi.Uint8> rom;

  @ffi.Array.multi([8192])
  external ffi.Array<ffi.Uint8> vram;

  @ffi.Array.multi([8192])
  external ffi.Array<ffi.Uint8> eram;

  @ffi.Array.multi([8192])
  external ffi.Array<ffi.Uint8> wram;

  @ffi.Array.multi([160])
  external ffi.Array<ffi.Uint8> oam;

  @ffi.Array.multi([128])
  external ffi.Array<ffi.Uint8> io;

  @ffi.Array.multi([127])
  external ffi.Array<ffi.Uint8> hram;

  @ffi.Uint8()
  external int ie;

  @ffi.Array.multi([256])
  external ffi.Array<ffi.Uint8> boot_rom;

  @ffi.Bool()
  external bool boot_completed;
}
...
final class PPU extends ffi.Struct {
  @ffi.Array.multi([144, 160])
  external ffi.Array<ffi.Array<ffi.Uint32>> framebuffer;
